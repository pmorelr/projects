...
% update solution qv
   switch method
     ...
     case 'Roe'	
     for i=3:Ncp2
     fluip = fluxswRoe_templ(w(i,:),w(i+1,:)); 
     flui = fluxswRoe_templ(w(i-1,:),w(i,:));
     qv(i,:) = w(i,:) - dt/h*(fluip-flui);  
     end      
...
%      axis([xl xr  0  1.1])
      ...
      if (simulation == 0)
      csvwrite('1rusanov_height1000.csv',[x rhosol]) 
      csvwrite('1rusanov_velocity1000.csv',[x usol])
      csvwrite('1rusanov_momentum1000.csv',[x rhousol])
      else
      csvwrite('1roe_height1000.csv',[x rhosol]) 
      csvwrite('1roe_velocity1000.csv',[x usol])
      csvwrite('1roe_momentum1000.csv',[x rhousol])
      end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%      axis([xl xr  0  1.1])
      ...
      csvwrite('1exact_height.csv',[xx' rhoex']) 
      csvwrite('1exact_velocity.csv',[xx' uex'])
      csvwrite('1exact_momentum.csv',[xx' rhouex'])
