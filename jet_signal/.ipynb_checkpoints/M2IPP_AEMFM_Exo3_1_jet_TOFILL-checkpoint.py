...
dX = XX
plt.xlim([x0,x0+dX])
plt.savefig(f'../figures/jet{1000*dX}.png')
...
plt.grid()
plt.savefig(f'../figures/jet_moy{1000*Tint}.png')
...
plt.xscale('log')
plt.yscale('log')
plt.savefig(f'../figures/jet_freq_{Nfft}.png')
...
plt.savefig('../figures/jet_freq_VarDf.png')
...
plt.savefig('../figures/jet_PDF.png')
...
plt.xlim([-0.00001,.2])
plt.savefig('../figures/jet_Autocorr.png')
